...
$slider_btn = get_theme_mod( 'adore_blog_slider_button_label', __( 'Read More', 'blogin') );
?>
<div id="adore_blog_slider_section">
    <div id="slider-section" class="paddingt-b same content-alignment-left">
